...
public class PaymentRepository {
	...
	//retrieve specific record from payment table
	...
	//retreive units of account from db
	...
	//retrieve additional units from db
	...
	//read all monitor records from monitor db
	public String readMonitor() {
		Client c = Client.create();
		WebResource resource = c.resource("http://localhost:8090/PAF_MonitoringService/webapi/monitors");
